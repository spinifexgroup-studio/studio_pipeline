...
def spckProcessTemplateAepxFile (replacementSceneNumber, replacementShotNumber, camWidth, camHeight, exchangePath, renderPath, renderSceneName, renderCameraName):
	...
	templateRenderPath		  = '/Volumes/RED/01_Production/INTE1312_Spinifex_Perfect_Car_Kit/3_Studio/d_3D/Renders/scXXXX/shXXXX/'
	templateRenderCameraName  = 'shXXXX'
	...
	for line in fileIn:
		...
		if templateRenderPath in line:
			fileOut.write( line.replace(templateRenderPath, renderPath))

		elif templateShotName in line:
			...
			if templateShotName in asciiData or templateRenderCameraName in asciiData or templateSceneName in asciiData:
